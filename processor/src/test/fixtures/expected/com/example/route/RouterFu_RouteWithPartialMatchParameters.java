...
public class RouterFu_RouteWithPartialMatchParameters extends RouteWithPartialMatchParameters implements RouteWithPartialMatchParametersService {
  ...
  private final Route $fu$_route_regionFilter = new Route( "regionFilter", new Segment[]{new Segment( "/regions/" ), new Segment( $fu$_regionCode ), }, new Parameter[]{$fu$_regionCode, }, new RegExp( "^/regions/((?:[a-zA-Z0-9\\-_\\$\\.\\+!\\*'\\(\\)\\,\\\"~]|%[A-F0-9]{2})+)" ), ( location, route, parameters ) -> MatchResult.NON_TERMINAL );
