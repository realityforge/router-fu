...
public class RouterFu_RouteWithEmptyPath extends RouteWithEmptyPath
    implements RouteWithEmptyPathService {
  private final Route $fu$_route_welcome = new Route(
      "welcome",
      new Segment[] {},
      new Parameter[] {},
      new RegExp("^$"),
  ...
  RouterFu_RouteWithEmptyPath(@Nonnull final Backend backend) {
    $fu$_router = new Router(
        ...
        backend,
        Collections.unmodifiableList(Arrays.asList($fu$_route_welcome)));
    $fu$_router.activate();
  }
