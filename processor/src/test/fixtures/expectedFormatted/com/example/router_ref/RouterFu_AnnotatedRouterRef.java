...
public class RouterFu_AnnotatedRouterRef extends AnnotatedRouterRef
    implements AnnotatedRouterRefService {
  private final Router $fu$_router;

  private Location $fu$_location;

  RouterFu_AnnotatedRouterRef(@Nonnull final Backend backend) {
    $fu$_router =
