...
public class RouterFu_ProtectedRouterRef extends ProtectedRouterRef
    implements ProtectedRouterRefService {
  private final Router $fu$_router;

  private Location $fu$_location;

  RouterFu_ProtectedRouterRef(@Nonnull final Backend backend) {
    $fu$_router =
