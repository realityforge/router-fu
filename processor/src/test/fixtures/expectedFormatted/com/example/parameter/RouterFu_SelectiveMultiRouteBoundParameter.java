...
public class RouterFu_SelectiveMultiRouteBoundParameter extends SelectiveMultiRouteBoundParameter
    implements SelectiveMultiRouteBoundParameterService {
  ...
  RouterFu_SelectiveMultiRouteBoundParameter(@Nonnull final Backend backend) {
    $fu$_router = new Router(
        this::onLocationChanged,
        backend,
        Collections.unmodifiableList(
            Arrays.asList($fu$_route_region, $fu$_route_regionEvents, $fu$_route_regionEvent)));
    $fu$_router.activate();
  }
