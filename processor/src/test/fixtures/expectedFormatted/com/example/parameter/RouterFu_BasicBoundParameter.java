...
public class RouterFu_BasicBoundParameter extends BasicBoundParameter
    implements BasicBoundParameterService {
  ...
  RouterFu_BasicBoundParameter(@Nonnull final Backend backend) {
