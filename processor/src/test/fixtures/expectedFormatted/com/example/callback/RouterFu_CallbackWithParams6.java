...
public class RouterFu_CallbackWithParams6 extends CallbackWithParams6
    implements CallbackWithParams6Service {
  ...
  private final Route $fu$_route_region = new Route(
      ...
      (location, route, parameters) -> regionCallback(parameters, route, location));
  ...
  RouterFu_CallbackWithParams6(@Nonnull final Backend backend) {
