...
public class RouterFu_CallbackWithParams1 extends CallbackWithParams1
    implements CallbackWithParams1Service {
  ...
  private final Route $fu$_route_region = new Route(
      ...
      (location, route, parameters) -> regionCallback(location));
  ...
  RouterFu_CallbackWithParams1(@Nonnull final Backend backend) {
