...
public class RouterFu_CallbackFromInterface extends CallbackFromInterface
    implements CallbackFromInterfaceService {
  ...
  private final Route $fu$_route_region = new Route(
      ...
      (location, route, parameters) -> regionCallback());
  ...
  RouterFu_CallbackFromInterface(@Nonnull final Backend backend) {
