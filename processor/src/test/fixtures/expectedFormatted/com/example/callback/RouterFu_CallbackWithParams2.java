...
public class RouterFu_CallbackWithParams2 extends CallbackWithParams2
    implements CallbackWithParams2Service {
  ...
  private final Route $fu$_route_region = new Route(
      ...
      (location, route, parameters) -> regionCallback(route));
