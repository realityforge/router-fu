...
public class RouterFu_CallbackWithParams4 extends CallbackWithParams4
    implements CallbackWithParams4Service {
  ...
  private final Route $fu$_route_region = new Route(
      ...
      (location, route, parameters) -> regionCallback(parameters, location));
  ...
  RouterFu_CallbackWithParams4(@Nonnull final Backend backend) {
