...
public class RouterFu_CallbackWithCustomName extends CallbackWithCustomName
    implements CallbackWithCustomNameService {
  ...
  private final Route $fu$_route_region = new Route(
      ...
      (location, route, parameters) -> region());
  ...
  RouterFu_CallbackWithCustomName(@Nonnull final Backend backend) {
