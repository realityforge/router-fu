...
public class RouterFu_CallbackWithParams5 extends CallbackWithParams5
    implements CallbackWithParams5Service {
  ...
  private final Route $fu$_route_region = new Route(
      ...
      (location, route, parameters) -> regionCallback(route, parameters, location));
  ...
  RouterFu_CallbackWithParams5(@Nonnull final Backend backend) {
