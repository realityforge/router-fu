...
public class RouterFu_CallbackWithParams1 extends CallbackWithParams1 implements CallbackWithParams1Service {
  ...
  private final Route $fu$_route_region = new Route( "region", new Segment[]{new Segment( "/regions/" ), new Segment( $fu$_regionCode ), }, new Parameter[]{$fu$_regionCode, }, new JsRegExp( "^/regions/([a-zA-Z0-9\\-_]+)$" ), ( location, route, parameters ) -> regionCallback( location ) );
